...
Widget buildBottomSheet(BuildContext context, Function getAvg) {
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextField(
              ...
              autofocus: true,
              decoration:
                  kTextFieldDecoration.copyWith(hintText: 'enter_reading'.tr()),
            ),
          ),
          TextButton(
            style: TextButton.styleFrom(
                backgroundColor: Provider.of<myTheme>(context).theme
                    ...
                    : Colors.greenAccent),
            onPressed: () async {
              String readingText = readingController.text.trim();

              if (!isValidReading(readingText)) {
                showValidationError();
                return;
              }

              int reading = int.parse(readingText);
              ...
              try {
                await firebaseService.addSugarReading(
                  reading,
